...
-- {{{ Tags
tags = {
  names  = { "main", "web", "code", "mail", "im", 6, 7, "ssh", "media" },
  layout = { layouts[2], layouts[1], layouts[2], layouts[4], layouts[1],
...
-- Register widget
-- vicious.register(mailwidget, vicious.widgets.mbox, "$1", 181, {home .. "/Mail/file", 15})
-- Register buttons
...
datewidget:buttons(awful.util.table.join(
  awful.button({ }, 1, function () exec("getip") end)
))
-- }}}
